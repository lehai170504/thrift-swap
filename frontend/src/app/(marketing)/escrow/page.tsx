import { ShieldCheck, Wallet, RefreshCw, CheckCircle, ArrowRight } from 'lucide-react';
import Link from 'next/link';
import { Button } from '@/components/ui/button';

export const metadata = {
  title: 'Chính sách Escrow | ThriftSwap',
  description: 'Tìm hiểu về hệ thống thanh toán trung gian an toàn tuyệt đối trên ThriftSwap.',
};
            ...
            <div className="grid md:grid-cols-3 gap-12 relative z-10">
              ...
              <div className="text-center">
                ...
                <p className="text-neutral-500 leading-relaxed">
                  Khi bạn thanh toán đơn hàng, tiền sẽ được trừ vào ví nhưng <span className="font-semibold text-neutral-900">chưa chuyển cho người bán</span>. Số tiền này được ThriftSwap "Giam giữ" an toàn.
                </p>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-100">
                ...
                <p className="text-neutral-600 pl-4">
                  Tiền vẫn đang nằm trong hệ thống Escrow của ThriftSwap! Bạn chỉ cần nhấn báo cáo lỗi trong vòng 3 ngày kể từ khi nhận hàng. Đội ngũ quản trị viên sẽ xem xét bằng chứng và <span className="font-semibold text-neutral-900">hoàn lại 100% tiền</span> về ví của bạn nếu người bán có gian lận.
                </p>
              </div>
