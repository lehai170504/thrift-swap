      ...
      <section className="py-24 bg-background border-t border-border/50 overflow-hidden" ref={ctaRef}>
        <div className="w-full px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto">
          <motion.div
            ...
            className="dark bg-background text-foreground rounded-[2.5rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl"
          >
            <div className="relative z-10 max-w-2xl mx-auto">
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                animate={ctaInView ? { opacity: 1, y: 0 } : {}}
                className="text-4xl md:text-5xl font-bold mb-6 leading-tight text-foreground font-sans"
              >
              ...
              >
                <Button onClick={openRegisterModal} size="lg" className="w-full sm:w-auto h-14 px-10 text-base bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl font-semibold shadow-lg shadow-primary/30">
                Tạo tài khoản miễn phí
              </Button>
              <Link href="/products" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-10 text-base border-border text-foreground hover:bg-muted rounded-xl transition-colors group">
