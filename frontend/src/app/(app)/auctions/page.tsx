      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col mb-8 gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg text-neutral-500 mt-2">Nơi săn những món đồ độc lạ với mức giá do bạn quyết định.</p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-24 bg-white rounded-3xl border border-neutral-100 shadow-sm">
            ...
            <h3 className="text-xl font-bold text-neutral-900 mb-2">Chưa có phiên đấu giá nào</h3>
