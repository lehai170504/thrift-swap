...
export function FeaturedProducts() {
  ...
  return (
    <section className="py-24 bg-background border-b border-white/5 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500/10 blur-[100px] rounded-full -z-10 translate-x-1/2 -translate-y-1/2"></div>

      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-[24px] bg-orange-500/10 border border-orange-500/20 text-orange-400 font-semibold text-sm mb-4">
          ...
          <Link href="/products">
            <Button variant="outline" className="rounded-[24px] px-6 h-12 text-primary border-primary/20 hover:bg-primary/10 hover:border-primary/50 transition-all glass">
