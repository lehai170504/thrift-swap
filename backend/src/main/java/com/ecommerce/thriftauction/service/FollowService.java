...
import com.ecommerce.thriftauction.repository.FollowRepository;
...
public class FollowService {
    ...
    @Transactional(readOnly = true)
    public java.util.List<com.ecommerce.thriftauction.dto.UserResponse> getFollowers(String username) {
        User following = userRepository.findByUsername(username)
        ...
        return followRepository.findByFollowing(following).stream()
                .map(f -> {
                    ...
                    return com.ecommerce.thriftauction.dto.UserResponse.builder()
                            .id(u.getId())
